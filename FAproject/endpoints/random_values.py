...
async def get_random_int_by_seed(min_value: int = Query(0, description='Min value of generated integer'),
                                 ...
                                 seed: Union[int, str, float] = Path(..., description='Ranodm seed for '
...
async def get_random_float(min_value: float = Body(0, description='Min value of generated integer'),
                           max_value: float = Body(255, description='Max value of generated integer'),
                           seed: Union[float, str, int] = Body(42, description='Ranodm seed for generate value'),
